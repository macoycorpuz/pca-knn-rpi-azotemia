...
ax_pca_btn = plt.axes([0.34, 0.04, 0.13, 0.05])
ax_knn_btn = plt.axes([0.47, 0.04, 0.13, 0.05])
ax_svm_btn = plt.axes([0.50, 0.04, 0.13, 0.05])
ax_close = plt.axes([0.65, 0.04, 0.13, 0.05])
